...
namespace JasonLong.Helper
{
    public class JSFunctionHelper
    {
        ...
        /// 获取登录随机参数的值
        /// </summary>
        /// <param name="key">随机参数</param>
        /// <param name="value"></param>
        /// <returns></returns>
        public static string GetRandomParamCodes(string key,string value)
        {
            ...
            string strResult = script.Run("getEncryptCode", new object[] { key, value }, func).ToString();
            return strResult;
        }
    }
}
